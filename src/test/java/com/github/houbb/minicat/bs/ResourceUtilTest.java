...
public class ResourceUtilTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Class Loader Resource: " + getClassLoaderResource(ResourceUtilTest.class));
        System.out.println("Class Root Resource: " + getClassRootResource(ResourceUtilTest.class));
        System.out.println("Class Resource: " + getClassResource(ResourceUtilTest.class));
